...
<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Master Data — Layanan</h2>
    </x-slot>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($services as $service)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-5 py-3">
                                        ...
                                        <div class="max-w-md truncate text-xs text-gray-500">{{ $service->description }}</div>
                                    </td>
                                    ...
                                    <td class="px-5 py-3">
                                        @if ($service->is_active)
                                            <x-status-badge color="bg-green-100 text-green-800" label="Aktif" />
                                        @else
                                            <x-status-badge color="bg-gray-100 text-gray-800" label="Nonaktif" />
                                        @endif
                                    </td>
                                    <td class="px-5 py-3">
                            ...
                            @empty
                                <tr><td colspan="7" class="px-5 py-10 text-center text-gray-500">Belum ada layanan.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
