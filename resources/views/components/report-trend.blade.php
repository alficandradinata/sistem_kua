...
<div class="overflow-hidden rounded-lg bg-white shadow-sm">
    <div class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 px-5 py-3">
        <h3 class="text-sm font-semibold text-gray-700">Tren Reservasi Harian</h3>
        ...
        <div class="px-5 pb-4 pt-6">
            ...
            <div class="overflow-x-auto pt-5">
                        ...
                        <div class="group relative flex flex-1 flex-col items-center">
                            ...
                            <div class="flex w-full flex-col items-center justify-end" style="height: {{ $plotHeight }}px">
                                @if ($hari === $puncak && $hari->total > 0)
                                    <span class="mb-1 text-center text-[10px] font-semibold tabular-nums text-gray-500">
                                        {{ $hari->total }}
                                    </span>
                                @endif
                            ...
                            <div class="pointer-events-none absolute left-1/2 top-0 z-10 hidden w-36 -translate-x-1/2
                                        rounded-md bg-gray-900 px-3 py-2 text-left text-[11px] leading-4 text-white
                ...
                <div class="flex gap-1 pt-1.5" style="min-width: {{ max(320, $trend->count() * 22) }}px">
                    @foreach ($trend as $hari)
                        <span class="flex-1 text-center text-[10px] tabular-nums text-gray-400">
                            {{ $hari->date->day }}
                        </span>
                    @endforeach
                </div>
